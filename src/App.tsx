              ...
              <div className="flex gap-1 bg-slate-100 p-0.5 rounded-lg text-[10px] font-bold">
                {(['All', 'High', 'Medium', 'Low'] as const).map(tab => (
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-md transition-all ${riskFilter === tab
              ...
              {(['ALL', 'HIGH', 'MEDIUM', 'LOW'] as const).map(rf => {
                ...
                return (
                  <button
                    ...
                    className={`px-2 py-0.5 rounded-md transition-colors ${isActive
            ...
            {filteredClauses.map(c => {
              ...
              return (
                <div
                  key={c.id}
                  onClick={() => handleClauseClick(c.id)}
                  className={`clickable-clause-card transition-all duration-200 ${isSelected
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <ChevronDown
                        size={14}
                        className={`text-slate-400 transition-transform duration-200 ${isSelected ? 'rotate-180 text-indigo-600' : ''
                          }`}
                      />
                    </div>
                  </div>
